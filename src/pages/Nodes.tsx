    ...
    <div className="relative min-h-screen bg-black">
      ...
      <main className="relative z-10 pt-32 pb-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h3 className="text-[10px] uppercase tracking-[0.3em] text-grey-300 mb-4 text-center">
              Status Legend
            </h3>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-center gap-4 sm:gap-8">
              <div className="flex items-center gap-2">
                ...
                <span className="text-base text-grey-300"><span className="text-primary font-medium">LIVE</span> — Click to view</span>
              </div>
              <div className="flex items-center gap-2">
                <Lock className="w-3 h-3 text-grey-300" />
                <span className="text-base text-grey-300"><span className="text-grey-400 font-medium">SEALED</span> — Hover reveals details + Request Access</span>
              </div>
              <div className="flex items-center gap-2">
                <CircleDot className="w-3 h-3 text-grey-600" />
                <span className="text-base text-grey-300"><span className="text-grey-300 font-medium">DORMANT</span> — Hover reveals unlock order</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            {[
              ...
              <div key={i} className="text-center">
                ...
                <span className="block text-[10px] uppercase tracking-[0.3em] text-grey-300 mt-2">{stat.label}</span>
              </div>
            ))}
          </motion.div>
          ...
          <section className="mb-24">
            ...
            >
              ...
              />
              <h2 className="text-base uppercase tracking-[0.4em] text-primary font-medium">
              ...
              {liveNodes.map((node, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {node.domain && (
                      <p className="text-[10px] uppercase tracking-[0.2em] text-grey-300 mb-4">
                        {node.domain}
                      </p>
                    )}

                    <p className="text-grey-400 text-base leading-relaxed mb-8">
                      {node.purpose}
                    </p>
                    ...
                    <Link
                      to={`/nodes/${node.id}`}
                      className="block mt-3 text-[10px] uppercase tracking-[0.3em] text-grey-300 hover:text-grey-300 transition-colors text-center"
                    >
                      Read Node →
                    </Link>
                  </motion.div>
          ...
          <section className="mb-24">
            <motion.div
              ...
              className="flex items-center gap-3 mb-8"
            >
              <Lock className="w-4 h-4 text-grey-300" />
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <span className="text-2xl font-light text-grey-300/60 tabular-nums">{sequenceNum}</span>
                      <div className="flex items-center gap-2">
                        <Lock className="w-3 h-3 text-grey-300/60" />
                    ...
                    <p className="text-grey-300 text-base leading-relaxed mb-4">
                      {node.purpose}
                    </p>
                    ...
                    {/* Hover overlay tooltip */}
                     <div className="absolute inset-0 bg-black/95 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-6 text-center pointer-events-none group-hover:pointer-events-auto">
                      ...
                      <p className="text-grey-300 text-base font-medium mb-2">SEALED — Unlock Order: #{sequenceNum}</p>
                      <p className="text-grey-300 text-base mb-1">Monitoring: staged / build queued</p>
                      ...
                      <Link to="/request-access" onClick={(e) => e.stopPropagation()}>
                        <ApexButton variant="outline" size="sm" className="text-base pointer-events-auto">
                          Request Access →
                        </ApexButton>
                      </Link>
                    </div>
          ...
          <section>
            ...
            >
              ...
              <h2 className="text-base uppercase tracking-[0.4em] text-grey-300 font-medium">
            ...
            <motion.p
              ...
              whileInView={{ opacity: 1 }}
              viewport={{ once: true }}
              className="text-grey-600 text-base mb-8 max-w-2xl"
            >
                  ...
                  >
                    ...
                    {/* Hover overlay */}
                     <div className="absolute inset-0 bg-black/95 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center p-5 text-center pointer-events-none group-hover:pointer-events-auto">
                      ...
                      <p className="text-grey-400 text-base font-medium mb-2">DORMANT — Unlock Order: #{sequenceNum}</p>
                      ...
                      <Link to="/request-access" onClick={(e) => e.stopPropagation()}>
                        <ApexButton variant="ghost" size="sm" className="text-base text-grey-400 pointer-events-auto">
                          Join Unlock List →
                        </ApexButton>
                      </Link>
                    </div>
